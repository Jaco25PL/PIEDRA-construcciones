...
export function Form({ fromRef }) {
    ...
    const onsubmit = () => {
        if(sendRef.current){
            console.log(sendRef.current.submit())
        }   
    }
