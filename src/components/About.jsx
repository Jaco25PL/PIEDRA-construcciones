        ...
        <section className='max-w-full sm:mx-0 md:mx-20 xl:mx-40 relative '>
            <div className=' mt-9 pt-10 flex flex-col items-center before:content-[""] before:absolute before:top-0  before:h-1 before:w-1/2 before:bg-gray-300 '>
                ...
                <div className="text-center">
                    <h1 className="text-center mb-6">CONOCÉ AL <span className="font-bold text-5xl">EQUIPO</span></h1>
                ...
                <div className="text-center [&>*]:mx-auto mb-6">
                    <h1 className="text-5xl tracking-tighter mb-6">¿QUIÉNES NOS <span className="text-5xl font-bold">RECOMIENDAN</span>?</h1>
