        ...
        <div className='mt-10 lg:mt-0 sm:mx-4 flex flex-col items-center'>
          ...
          >
            <Swiper 
              ...
              className="mySwiper aspect-video overflow-hidden sm:rounded-md lg:max-h-[600px] xl:max-w-[900px] sm:[&_img]:rounded-md lg:[&_img]:w-full"
            >
              {
                headerSlider?.map(e => (
